        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><strong>Edit Data Kelas</strong></h3>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('kelas.update', $kelas->id_kelas) }}" method="POST">
                        @csrf
                        @method('PUT') {{-- method spoofing karena HTML hanya support GET dan POST --}}
                            ...
                            <select class="form-control" id="tahun_ajaran" name="tahun_ajaran" required 
                                ...
                                @php
                                    ...
                                    for ($i = -5; $i <= 5; $i++) {
                                        ...
                                        $tahun2 = $tahun1 + 1;
                                        $value = "{$tahun1}/{$tahun2}";
                                        $selected = ($kelas->tahun_ajaran == $value) ? 'selected' : '';
